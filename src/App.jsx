...
const PARTICIPANTS = [
  { id: 1, name: "Andrés Adam", role: "Edad: 25", img: "./Andres_Adam-removebg-preview.png" },
  { id: 2, name: "Andrés Moreno", role: "Edad: 33", img: "./Andres_Moreno-removebg-preview.png" },
  { id: 3, name: "Benjamin Delgado", role: "Edad: 26", img: "./Benjamin_Delgado-removebg-preview.png" },
  { id: 4, name: "Dany Vega", role: "Edad: 43", img: "./Dany_Vega-removebg-preview.png" },
  { id: 5, name: "Elian Irala", role: "Edad: 25", img: "./silueta_2-removebg-preview.png" },
  { id: 6, name: "Esteban Arce", role: "Edad: 30", img: "./Esteban_Arce-removebg-preview.png" },
  { id: 7, name: "Federico Cla", role: "Edad: 25", img: "./Federico_Cla-removebg-preview.png" },
  { id: 8, name: "Gadiel Gomez", role: "Edad: 26", img: "./Gadiel_Gomez-removebg-preview.png" },
  { id: 9, name: "Leudys Santana", role: "Edad: 33", img: "./Leudys_Santana-removebg-preview.png" },
  { id: 10, name: "Matias Herrera", role: "Edad: 29", img: "./Matias_Herrera-removebg-preview.png" },
  { id: 11, name: "Nahuel Gerez", role: "Edad: 21", img: "./Nahuel_Gerez-removebg-preview.png" },
  { id: 12, name: "Nahuel Perez", role: "Edad: 30", img: "./Nahuel_Perez-removebg-preview.png" },
  { id: 13, name: "Nicolás González", role: "Edad: 20", img: "./Nicolas_Gonzalez-removebg-preview.png" },
  { id: 14, name: "Santiago Leyria", role: "Edad: 29", img: "./Santiago_Leyria-removebg-preview.png" },
];
